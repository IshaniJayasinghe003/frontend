export default function AboutUsPage() {
  return (
    <div className="w-full h-screen relative">
      ...
      {/* White Card */}
      <div className="absolute top-1/2 right-10 transform -translate-y-1/2 bg-white rounded-2xl shadow-2xl p-8 max-w-md">
        ...
        {/* Bullet Points */}
        <ul className="list-disc text-gray-600 pl-5 mb-6 space-y-2">
