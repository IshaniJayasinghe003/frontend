...
export default function UpdateProductpage() {
  ...
  async function handleSubmit() {
    ...
    axios
      .put(import.meta.env.VITE_BACKEND_URL + "/api/products/" + productId, productData, {
        headers: {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="w-[600px] border-[3px] rounded-[15px] p-[40px] flex flex-wrap justify-between">
        <div className="w-[200px] flex flex-col gap-[13px]">
        ...
        <div className="w-[500px] flex flex-col gap-[13px]">
        ...
        <div className="w-[200px] flex flex-col gap-[5px]">
          ...
          >
            ...
            <option value="creame">Cream</option>
