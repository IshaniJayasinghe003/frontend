...
export default function HomePage() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      {/* Hero Section */}
<div className="flex flex-col md:flex-row items-center justify-between min-h-screen px-12 gap-12">
  ...
  <div className="w-full md:w-1/2 max-w-xl text-center md:text-left">
    ...
    <p className="text-lg text-gray-600 mb-3">
      Discover premium beauty products crafted with care and loved by everyone. 
      Enhance your style with Evara Cosmetics.
    </p>
